...
def submit_ray_job_callable(script_name, env_overrides=None, **kwargs):
    ...
    try:
        ...
        logger.warning(f"⚠️ Connexion Airflow 'postgres_default' introuvable ({e}). Repli sur l'environnement...")
...
with DAG(
    ...
    schedule_interval="0 21 * * *",  # S'exécute chaque jour à 21h00 locale/UTC
