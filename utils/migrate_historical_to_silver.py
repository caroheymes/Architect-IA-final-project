...
def migrate_historical():
    ...
    for i, file_path in enumerate(json_files, 1):
        ...
        try:
            ...
            df_silver['merged_h3_geometry_json'] = df_silver['merged_h3_geometry'].apply(to_json_str) if 'merged_h3_geometry' in df_silver.columns else None
            ...
            logger.info(f"🟢 Successfully migrated {len(df_silver_clean)} records from {filename} to silver.trafic_vitesse_propre")
