...
class TestTransformTrafficData(unittest.TestCase):
    ...
    def test_transform_traffic_data_pipeline_and_silver_push(self, mock_to_file, mock_to_csv, mock_makedirs, mock_create_engine):
        ...
        self.assertEqual(len(parsed_points), 3) # 13 meters with 7m interpolation interval -> d=0, d=7, d=13 (end point fallback)
